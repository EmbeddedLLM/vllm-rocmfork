...
class TritonMLAState(AttentionState):
    ...
    def graph_capture_get_metadata_for_batch(
        ...
        attn_metadata = self.runner.attn_backend.make_metadata(
            ...
            paged_kv_last_page_lens=self.
            _paged_kv_last_page_lens_tensor[:batch_size],
        )
    ...
    def get_graph_input_buffers(self,
        ...
        input_buffers = {
            ...
            "paged_kv_indptr":
            attn_metadata.decode_metadata.paged_kv_indptr,
            "paged_kv_indices":
            attn_metadata.decode_metadata.paged_kv_indices,
...
class TritonMLAImpl(MLACommonImpl[TritonMLAMetadata]):
    ...
    def _forward_decode(
        ...
        decode_attention_fwd(q, kv_c_and_k_pe_cache, kv_c_cache, o,
                             ...
                             PAGE_SIZE, attn_metadata.paged_kv_indptr,
