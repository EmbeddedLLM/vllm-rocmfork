...
def generate_kernel_param_files(output_dir):
    ...
    for id, op in enumerate(operations):
        ...
        with open(os.path.join(output_dir,f'machete_mm_out_{op["id"]}.cu'), 'w') as f:
            f.write(output)

def generate_kernel_header_file(output_dir):
    ...
    with open(os.path.join(output_dir,'machete_mm_kernel.h'), 'w') as f:
        f.write(header_output)


def generate_launcher_file(output_dir):
    # Render the header file
    ...
    # Write the header file
    with open(os.path.join(output_dir,'machete_mm_kernel_launcher.cu'), 'w') as f:
...
def generate():
    ...
    generate_kernel_param_files(output_dir)
    generate_kernel_header_file(output_dir)
    generate_launcher_file(output_dir)
