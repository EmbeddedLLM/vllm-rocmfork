...
constexpr uint32_t DEFAULT_BLOCKS_X = 2;
constexpr uint32_t DEFAULT_BLOCKS_Y = 2;
constexpr uint32_t DEFAULT_BLOCKS_Z = 2;
constexpr uint32_t DEFAULT_MBLOCKS_X = 2;
constexpr uint32_t DEFAULT_MBLOCKS_Y = 2;
